...
//                            button.setIcon(new ImageIcon(Board.class.getResource("/images/hit.png")));
//                            button.setDisabledIcon(new ImageIcon(Board.class.getResource("/images/hit.png")));
//                            StartGame.board.textArea.append(button.getName() + " is a hit \n");
//                            int Count = 0;
//                            for (int i = 0; i < StartGame.playerShips.size(); i++) {
//                                if (StartGame.playerShips.get(i).equals("/")) {
//                                    Count += Count-- - Count;
//                                } else {
//                                    Count = 0;
//                                }
...
//                            }
//                        } else {
//                            button.setIcon(new ImageIcon(Board.class.getResource("/images/miss.png")));
//                            button.setDisabledIcon(new ImageIcon(Board.class.getResource("/images/miss.png")));
...
//                        }
//                        if (done) {
//                            JOptionPane.showMessageDialog(null, "You lost \n Do you want to play again", "Game Over", JOptionPane.YES_OPTION, new ImageIcon(Board.class.getResource("/images/loss.png")));
//                            try {
